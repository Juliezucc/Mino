        ...
        },
        {
          ...
          rows: [
            ...
            },
            {
              ...
              value: 'Pour chaque appareil rattaché : le prénom de l’enfant auquel il est réservé s’il y en a un, le nom que son propriétaire a donné à son téléphone, l’état du blocage et la date du dernier contact, ainsi qu’un jeton de notification. Ce que vous avez choisi de bloquer ne nous parvient PAS — ni les noms, ni même le nombre : cela reste sur le téléphone. Sur iPhone et iPad, l’application elle-même ignore lesquelles, Apple ne lui remettant que des identifiants anonymes ; elle n’en connaît que le décompte, pour vous l’afficher. Sur Android, ce mécanisme n’existe pas : pour vous présenter la liste, Mino lit les applications installées et conserve le nom de celles que vous cochez dans la mémoire privée de l’application, sur cet appareil et nulle part ailleurs. Dans les deux cas, nous n’y avons aucun accès.',
            },
            {
              label: 'Abonnement',
